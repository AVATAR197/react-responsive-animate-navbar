...
export const ReactNavbar = ({ color, logo, menu, social }) => {
    ...
    return (
        <div>
            {width < 1150 ? (
                <MobileNav width={width} logoUrl={logoUrl} background={background} navLinks={navLinks} socialIcon={socialIcon} />
            ) : (
                <Controller>
                                    ...
                                    <div className={styles.header}>
                                        ...
                                        <div className={styles.navLinks}>
                                            <ul>
                                                {navLinks.map((link, i) => (
                                                    <li key={i}>
                                                        <NavLink onClick={link.onClick} exact to={link.to} activeClassName={styles.home}>
                                                            {link.name}
                                                        </NavLink>
                                                    </li>
                                                ))}
